  ...
  async updateStats() {
    const data = await new Promise((resolve) => {
      ...
      mysocket.on('data', (data) => {
        ...
        result['xmr-hashrate'] = parseInt(properties[0], 10) / 1000; // format to KH/s
        result['xmr-accepted'] = parseInt(properties[1], 10);
        result['xmr-rejected'] = parseInt(properties[2], 10);
