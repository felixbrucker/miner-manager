...
var self = module.exports = {
  testStratum : function (pool,rigName,callback){
    ...
    var worker=pool.worker+(pool.appendRigName ? "."+rigName : "");
            ...
            switch (parsed.id){
              case 1:
                if(parsed.error!==undefined&&parsed.error===null){
                  var req = '{"id": 2, "jsonrpc":"2.0", "method": "mining.authorize", "params": ["'+worker+'", "'+pass+'"]}';
                  mysocket.write(req + '\n');
                  mysocket.setTimeout(10000);
                }else{
                  callbackSent=true;
