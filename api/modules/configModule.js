...
var config = module.exports = {
  ...
  nhPools: [
    ...
    {enabled:true,isIgnored:false,name:"nicehash-sia",algo:"sia",url:"stratum+tcp://sia.#APPENDLOCATION#.nicehash.com:3360",isSSL:false,working:true},
    {enabled:true,isIgnored:false,name:"nicehash-blake2s",algo:"blake2s",url:"stratum+tcp://blake2s.#APPENDLOCATION#.nicehash.com:3361",isSSL:false,working:true}
  ],
  getConfig: function () {
  ...
  loadConfig: function () {
    fs.stat(configPath, function (err, stat) {
      if (err == null) {
        ...
        config.config.autoswitchPools=[
          {enabled:false,name:"nicehash-autoswitch",appendRigName:true,appendGroupName:false,worker:"",pass:"",location:"eu",pools:config.nhPools}
        ];
        config.config.logLevel="INFO";
        config.saveConfig();
        setTimeout(function(){
